...
Command: npx gltfjsx@6.1.2 floating.glb
*/
...
export function FloatingModel(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/src/assets/3dModels/floating.glb')
...
useGLTF.preload('/src/assets/3dModels/floating.glb')
